...
\newcommand{\dokumententitel}[0]{Automatisiertes Aktualisieren veralteter Stack-Overflow-Antworten mithilfe von Kommentaren: Eine Fallstudie zu SOUP}
...
\end{table}
% -------------------------------------------------------
\section{Fallstudie: Automatisiertes Aktualisieren von Stack-Overflow-Posts (\acs{SOUP})}\label{sec:soup}
